// ignore_for_file: unnecessary_brace_in_string_interps, unrelated_type_equality_checks
...
class ApiProvider {
  ...
  Future<ContestsLeagueResponseData> postContestList() async {
    ...
    var contestsLeagueCategoryListResponseData =
    ...
    try {
      ...
      if (responseData['categorylist'] != null &&
          responseData['categorylist'] != '' &&
          responseData['leagues'] != null) {
        if (responseData['teamlist'] != null &&
            responseData['teamlist'] != '') {
          var tlist = <String>[];
        ...
        if (responseData['totalcontest'] != null &&
            responseData['totalcontest'] != '') {
          resData.totalcontest =
              int.tryParse('${responseData['totalcontest'] ?? 0}')!;
        } else {
        ...
        categorylistTxtList.forEach((categorytext) {
          ...
          for (var key in responseData['leagues'].keys) {
            if (key == categorytext) {
              var contestsLeagueCategoryList =
                  ContestsLeagueCategoryListResponseData();
              final List<dynamic> dataList =
                  responseData['leagues'][categorytext];
              print(dataList);
              ...
              if (contestsLeagueListData.length > 0) {
                ...
                contestsLeagueCategoryList.categoryDescription =
                    descriptionlistTxtList[count];
                contestsLeagueCategoryList.contestsCategoryLeagueListData =
                    contestsLeagueListData;
                contestsLeagueCategoryListResponseData
                    .add(contestsLeagueCategoryList);
              }
            }
          }
        });
        resData.contestsCategoryLeagueListData =
            contestsLeagueCategoryListResponseData;
      }
    } catch (e) {
      print(e);
  ...
  matches_list lst = matches_list();
  Future<SquadsResponseData> getTeamDataa(matches_list lst) async {
    this.lst = lst;
    SquadsResponseData responseData;
    var map = lst.lstteam1player!.map((e) {
      final Map<String, dynamic> data = new Map<String, dynamic>();
      data['pid'] = int.parse(e.pid.toString());
      data['id'] = int.parse(e.id.toString());
      data['title'] = e.name;
      data['short_name'] = '';
      data['first_name'] = e.name!.split(' ')[0];
      data['last_name'] = e.name!.split(' ')[1];
      data['middle_name'] = '';
      data['birthdate'] = '';
      data['birthplace'] = '';
      data['country'] = lst.country1Name;
      data['playing_role'] = e.playerposition_id == "1"
          ? "bat"
          : e.playerposition_id == "2"
              ? "bowl"
              : e.playerposition_id == "3"
                  ? "wk"
                  : "all";
      data['batting_style'] = '';
      data['bowling_style'] = '';
      data['fielding_position'] = '';
      data['team_name'] = lst.country1Name;

      data['fantasy_player_rating'] = e.rating;
      data['nationality'] = lst.country1Name;
      data['team_id'] = int.parse(e.pid.toString());
      data['playing11'] = "true";
      data['isSelcted'] = true;
      if (e.img == null) {
        data['img'] =
    ...
    var map1 = lst.lstteam2player!.map((e) {
      final Map<String, dynamic> data = new Map<String, dynamic>();
      data['pid'] = int.parse(e.pid.toString());
      data['id'] = int.parse(e.id.toString());
      data['title'] = e.name;
      ...
      data['team_name'] = lst.country2Name;
      data['fantasy_player_rating'] = e.rating;
      data['nationality'] = lst.country2Name;
      data['team_id'] = int.parse(e.id.toString());
      data['playing11'] = "true";
      data['isSelcted'] = true;
      if (e.img == null) {
        data['img'] =
  ...
  Future<UserDetail> drawerInfoList() async {
    return UserDetail.fromJson(jsonDecode(
        '{"success":"1","message":"data get successfully","data":{}}'));
    //"balance":"736.00","deposit":"1810","cash_bonus":"0.00","wining_amount":"0.00","image":"https://www.menshairstylesnow.com/wp-content/uploads/2018/03/Hairstyles-for-Square-Faces-Slicked-Back-Undercut.jpg","email":"oliver@123@gmail.com","name":"Oliver","mobile_number":"9874563201","city":"NewYork"
  }
