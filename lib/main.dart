...
class _MyAppState extends State<MyApp> {
  ...
  void initState() {
    ...
    globals.phoneVerificationBloc!.onInisialList("88", "phoneNoData");
    FirstTime.getValues();
    super.initState();
  }
  ...
  var routes = <String, WidgetBuilder>{
    ...
    Routes.LOGIN: (BuildContext context) => new TabScreen(),
    Routes.TAB: (BuildContext context) => new TabScreen(),
    Routes.OTP: (BuildContext context) =>
        new OtpValidationScreen(ConstanceData.phoneNumber),
  };
}
