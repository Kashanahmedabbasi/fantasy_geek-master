// ignore_for_file: deprecated_member_use, unnecessary_null_comparison, unrelated_type_equality_checks, non_constant_identifier_names
...
import 'package:tempalteflutter/api/joincontest.dart';
...
import 'package:tempalteflutter/models/UserContext/usercontext.dart';
...
import 'package:tempalteflutter/modules/contests/teamview.dart';
...
class _ContestsScreenState extends State<ContestsScreen> {
  ...
  bool tab2 = false;
  bool tab3 = false;
  bool ismyteamdata = false;
  String? centry;
  String? cid;
  bool isjoin = false;
  String? cprizepool;
  List<UserContestData> lstucd = [];
  ContextBloc contextbloc = ContextBloc();
  MyTeamBloc myteambloc = MyTeamBloc();
  UserContextBloc usercontestbloc = UserContextBloc();

  @override
  void initState() {
    myteambloc.fixtureid = widget.id!;
    usercontestbloc.fxtid = widget.id;
    usercontestbloc.mtb = myteambloc;
    usercontestbloc.lstucd = this.lstucd;
    usercontestbloc.eventusercontextsink.add(UserContext_Action.Fetch);
    contextbloc.id = widget.id!;
              ...
              children: [
                InkWell(
                  onTap: () {
                    ...
                    contextbloc.id = widget.id!;
                    // final myteambloc = MyTeamBloc();
                    // final usercontestbloc = UserContextBloc();
                    contextbloc.eventcontextsink.add(Context_Action.Fetch);
                    setState(() {
                      tab1 = true;
                      tab2 = false;
                ...
                InkWell(
                  onTap: () {
                    usercontestbloc.dispose();
                    usercontestbloc = UserContextBloc();
                    usercontestbloc.fxtid = widget.id;
                    usercontestbloc.eventusercontextsink
                        .add(UserContext_Action.Fetch);
                    setState(() {
                      tab1 = false;
                      tab2 = true;
                      tab3 = false;
                ...
                InkWell(
                  onTap: () {
                    // usercontestbloc.dispose();
                    // usercontestbloc = UserContextBloc();
                    myteambloc = MyTeamBloc();
                    myteambloc.fixtureid = widget.id;
                    // usercontestbloc.fxtid = widget.id;
                    // usercontestbloc.mtb = myteambloc;
                    // usercontestbloc.eventusercontextsink
                    //     .add(UserContext_Action.FetchTeam);
                    myteambloc.eventmyteamsink.add(MyTeamAction.FetchTeam);
                    setState(() {
                      tab1 = false;
                      tab2 = false;
                      tab3 = true;
                    ...
                    RefreshIndicator(
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          return StreamBuilder<List<context_list>>(
                              stream: contextbloc.contextstream,
                                ...
                                if (snapshot.hasData) {
                                  if (snapshot.data!.isEmpty) {
                                    ...
                                    return RefreshIndicator(
                                      onRefresh: () async {
                                        contextbloc.id = widget.id!;
                                        contextbloc.eventcontextsink
                                            .add(Context_Action.Fetch);
                                      },
                                      child: ListView.builder(
                                            ...
                                            StickyHeader(
                                                ...
                                                content: InkWell(
                                                  ...
                                                  child: contestnt(
                                                      ...
                                                      snapshot.data![index]
                                                          .entryleft,
                                                      '${snapshot.data![index].entrycount} spot',
                                                      snapshot
                                                          .data![index].winner,
                                                      (int.parse(snapshot
                                                                  .data![index]
                                        ...
                                        content: InkWell(
                                          onTap: () {
                                            context_list cl = context_list(
                                                fixtureid: widget.id,
                                                id: snapshot
                                                    .data![index].contest!.id,
                                                entrycapacity: snapshot
                                                    .data![index]
                                                    .contest!
                                                    .entrycapacity,
                                                prizepool: snapshot.data![index]
                                                    .contest!.prizepool,
                                                entryfee: snapshot.data![index]
                                                    .contest!.entryfee,
                                                entryleft: snapshot.data![index]
                                                    .contest!.entryleft,
                                                entrycount: snapshot
                                                    .data![index]
                                                    .contest!
                                                    .entrycount,
                                                winner: snapshot.data![index]
                                                    .contest!.winner,
                                                pricelst: snapshot.data![index]
                                                    .contest!.pricelst,
                                                firstprice: snapshot
                                                    .data![index]
                                                    .contest!
                                            ...
                                            ContestsScreen s = ContestsScreen(
                                              id: widget.id,
                                              lstteam1player:
                                                  widget.lstteam1player,
                                              lstteam2player:
                                                  widget.lstteam2player,
                                              key: widget.key,
                                              titel: widget.titel,
                                              time: widget.time,
                                              country1Flag: widget.country1Flag,
  ...
  Widget MyTeamData() {
    return StreamBuilder<List<MyTeam>>(
        stream: myteambloc.myteamstream,
        builder: ((context, snapshot) {
          if (snapshot.hasError) {
            return Center(
              child: Text(snapshot.error.toString()),
          ...
          if (snapshot.hasData) {
            return Expanded(
              child: ListView.builder(
                  ...
                  itemBuilder: ((context, index) {
                    isjoin = false;
                    usercontestbloc.lstucd.forEach((element) {
                      if (element.contestid == cid) {
                        if (element.teamid == snapshot.data![index].id)
                          isjoin = true;
                      }
                    });
                    return InkWell(
                                      ...
                                      Container(
                                        ...
                                        decoration: BoxDecoration(
                                            ...
                                            image: DecorationImage(
                                                image: AssetImage(ConstanceData
                                                    .cricketGround),
                                                fit: BoxFit.cover)),
                                        child: Column(
                                          children: [
  ...
  Widget GetMyTeamData(String centry, String cid, String prizepool) {
    return StreamBuilder<List<MyTeam>>(
        stream: myteambloc.myteamstream,
        builder: ((context, snapshot) {
          if (snapshot.hasError) {
                        ...
                        children: <Widget>[
                          ...
                          InkWell(
                            onTap: () {
                              ...
                              myteambloc.eventmyteamsink
                                  .add(MyTeamAction.FetchTeam);

                              showDialog(
                                  context: context,
                                  builder: (_) =>
                                      GetMyTeamData(txt2, id!, txt1));
                            },
                            child: Container(
                              width: 90,
                              decoration: BoxDecoration(
  ...
  Future<void> setshowDialog(
      String entry, String id, String prizepool, String teamid) async {
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            Container(
                              child: Text(
                                'Unutilized Balance + Winning = ৳$prizepool',
                                style: TextStyle(
                                  fontFamily: 'Poppins',
                                  fontWeight: FontWeight.w500,
                                  color: AllCoustomTheme.getTextThemeColors(),
                        ...
                        child: Container(
                          ...
                          child: Material(
                            ...
                            child: InkWell(
                              borderRadius: new BorderRadius.circular(4.0),
                              onTap: () async {
                                joinusercontext jc = joinusercontext();
                                UserData? user =
                                ...
                                jc.teamid = teamid;
                                jc.transactionid = "1";
                                joincontest jcapi = joincontest();
                                LoadingDialog(context);
                                var result = await jcapi.post(jc.tomap());
                                if (result == "okay") {
                                  Navigator.pop(context);
