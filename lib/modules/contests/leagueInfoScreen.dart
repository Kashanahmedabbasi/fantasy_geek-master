...
import 'package:tempalteflutter/models/leagueMemberListResponse.dart'
    as leagues;
import 'package:tempalteflutter/models/leagueMemberTeamResponse.dart'
    as leagueMember;
...
class _LeagueInfoScreenState extends State<LeagueInfoScreen>
  ...
  Future getTeamList() async {
    var team = await ApiProvider()
        .getCreatedTeamList('${widget.shedualData!.matchId}');
                                    ...
                                    text: TextSpan(
                                      children: [
                                        scorecardResponce!.teams![0].overs != ''
                                            ? TextSpan(
                                                text:
                                                    '${scorecardResponce!.teams![0].shortName}',
                                                style: TextStyle(
                                                  fontFamily: 'Poppins',
                                        ...
                                        scorecardResponce!.teams![0].scores !=
                                            ...
                                            ? TextSpan(
                                                text:
                                                    '       ${scorecardResponce!.teams![0].scores!.replaceAll('/', ' - ')}',
                                                style: TextStyle(
                                                  fontFamily: 'Poppins',
                                                  fontSize: ConstanceData
                                                      .SIZE_TITLE12,
                                        ...
                                        scorecardResponce!.teams![1].overs != ''
                                            ? TextSpan(
                                                text:
                                                    '${scorecardResponce!.teams![1].shortName}',
                                                style: TextStyle(
                                                  fontFamily: 'Poppins',
                                                  fontSize: ConstanceData
                                                      .SIZE_TITLE12,
                                        ...
                                        scorecardResponce!.teams![1].scores !=
                                            ...
                                            ? TextSpan(
                                                text:
                                                    '       ${scorecardResponce!.teams![1].scores!.replaceAll('/', ' - ')}',
                                                style: TextStyle(
                                                  fontFamily: 'Poppins',
                                                  fontSize: ConstanceData
                                                      .SIZE_TITLE12,
  ...
  void setPriceClickEvent(ContestsLeagueListData listData) async {
    ...
    if (double.parse(listData.entryFees!) <=
        double.parse(userData.data!.balance!)) {
      if (categoryList!.teamlist!.length != listData.leagueMember!.length) {
        if (categoryList!.teamlist!.length > 0) {
          var count =
              categoryList!.teamlist!.length - listData.leagueMember!.length;
          if (count >= 2) {
            await Navigator.push(
              context,
              MaterialPageRoute(
            ...
            setshowDialog(teamId, listData.leagueId!, listData.entryFees!,
                userData.data!);
          }
        }
      } else {
      ...
      await Navigator.push(
        ...
        MaterialPageRoute(
          builder: (context) => PymentScreen(
              paymetMoney:
                  '${double.parse(listData.entryFees!) - double.parse(userData.data!.balance!)}',
                  ...
                  children: <Widget>[
                    ...
                    widget.tabtype != TabType.Upcoming &&
                        ...
                        ? Container(
                            ...
                            child:
                                listData == null ? SizedBox() : progressBar(),
                          )
                        : SizedBox(),
                    SizedBox(
                      height: 12,
  ...
  void setshowDialog(
      String teamId, String leagueId, String entryFee, UserData userData) {
    var cashBonus = '';
    var unutilizedBalanceWinning =
        '${(double.tryParse(userData.winingAmount!)! + double.parse(userData.balance!)).toStringAsFixed(2)}';

    if ((double.tryParse(entryFee)! * 0.20) <
        double.parse(userData.cashBonus!)) {
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      Container(
                        padding:
                            EdgeInsets.only(left: 16.0, right: 16, bottom: 8),
                        child: Text(
            ...
            child: Column(
              children: <Widget>[
                                      ...
                                      Navigator.push(
                                        ...
                                        MaterialPageRoute(
                                          builder: (context) =>
                                            ...
                                            leagueId: listData.leagueId!,
                                            selectedTeamId:
                                                leagueMemberList[index].teamId!,
                                            teamSelectionType:
                                                TeamSelectionType.swap,
                                            fixtureid: widget.fixtureid,
                                          ),
                                          fullscreenDialog: true,
                                        ),
                ...
                listData != null &&
                    ...
                    ? Container(
                        padding: EdgeInsets.only(
                            left: 16, bottom: 8, right: 16, top: 4),
                        child: RichText(
                          textAlign: TextAlign.justify,
                          text: TextSpan(
                            children: [
                              TextSpan(
                                text:
                                    'Your entry fee has been refunded for the ',
                                style: TextStyle(
                                  fontFamily: 'Poppins',
                                  fontSize: ConstanceData.SIZE_TITLE14,
                                  color: Colors.grey,
                              ...
                              TextSpan(
                                text:
                                    ' contest. The contest you joined had to be cancelled as all the slots were not filled.',
                                style: TextStyle(
                                  fontFamily: 'Poppins',
                                  fontSize: ConstanceData.SIZE_TITLE14,
                                  color: Colors.grey,
    ...
    return Container(
      ...
      child: Row(
        children: <Widget>[
          ...
          Container(
            child: Opacity(
              opacity: widget.tabtype != TabType.Upcoming &&
                      contestJoinedData.isFull != '0'
                  ? 1.0
                  : 0.4,
              child: Container(
...
class LeaguesListView extends StatelessWidget {
    ...
    if (listData != null && tabtype != TabType.Upcoming) {
      if (contestJoinedData!.isFull != '0') {
        ...
        listData!.leagueWiner!.forEach((data) {
          var listPotition =
              data.postion!.replaceAll(' ', '').trim().split('-');
  ...
  Widget build(BuildContext context) {
    return Container(
      color: leagueTeam!.userId == globals.userdata!.userId
          ? AllCoustomTheme.getThemeData().primaryColor.withOpacity(0.1)
          : Colors.transparent,
      child: InkWell(
        onTap: () {
          allClick!();
                  ...
                  InkWell(
                    ...
                    child: Container(
                      ...
                      child: leagueTeam!.image != ""
                          ? AvatarImage(
                              imageUrl: ConstanceData.UserImageUrl +
                                  leagueTeam!.image!,
                              sizeValue: 44,
                              radius: 44,
                              isCircle: true,
                                  ...
                                  child: Row(
                                    ...
                                    children: <Widget>[
                                      ...
                                      tabtype == TabType.Live
                                          ...
                                          : Text(
                                              leagueTeam!.winningAmount != ""
                                                  ? '  YOU WON ৳${leagueTeam!.winningAmount}'
                                                  : '  WINNER! ',
                                              style: TextStyle(
                                                  fontFamily: 'Poppins',
                                                  fontSize: ConstanceData
                              ...
                              tabtype == TabType.Live
                                  ? leagueTeam!.pointsStatus == "="
                                      ? Container(
                                          ...
                                          height: 22,
                                          child:
                                              Image.asset(ConstanceData.arrowE),
                                        )
                                      : leagueTeam!.pointsStatus == ">"
                                          ? Container(
                                              width: 22,
