...
class PlayerProfileScreen extends StatefulWidget {
  ...
  const PlayerProfileScreen(
      {Key? key, this.player, this.isChoose = false, this.shedualData})
      : super(key: key);
  @override
...
class _PlayerProfileScreenState extends State<PlayerProfileScreen> {
  ...
  Widget addToTeam() {
    ...
    if (isValidMini != null && !widget.player!.isSelcted!) {
      if (isValidMini !=
          teamSelectionBloc.getTypeTextEnum(widget.player!.playingRole!)) {
        if (!isValidMiniMach(
            teamSelectionBloc.getTypeTextEnum(widget.player!.playingRole!)!,
                    ...
                    if (!isDisabled) {
                      ...
                      if (isValidMini != null && !widget.player!.isSelcted!) {
                        if (isValidMini !=
                          ...
                          if (!isValidMiniMach(
                              teamSelectionBloc.getTypeTextEnum(
