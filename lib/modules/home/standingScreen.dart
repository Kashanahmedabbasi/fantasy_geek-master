...
class StandingScreen extends StatefulWidget {
  ...
  const StandingScreen({Key? key, this.menuCallBack, this.upComingMatchesClick})
      : super(key: key);
  @override
...
class _StandingScreenState extends State<StandingScreen>
  ...
  final GlobalKey<RefreshIndicatorState> refreshIndicatorKeyL =
      new GlobalKey<RefreshIndicatorState>();
  final GlobalKey<RefreshIndicatorState> refreshIndicatorKeyR =
      new GlobalKey<RefreshIndicatorState>();
    ...
    return Container(
      child: BlocBuilder(
        ...
        builder: (context, StandingsTabBlocState state) {
          return standingsTabBloc!.getData(tabType!).length == 0 &&
                  state.isProgress
              ? Container(
                  child: Center(
                    child: Container(
                                  ...
                                  children: <Widget>[
                                    Expanded(
                                      child: RefreshIndicator(
                                        ...
                                        child: ListView.builder(
                                          itemCount: standingsTabBloc!
                                              .getScheduleData()
                                              .length,
                                          itemBuilder: (context, index) {
                                            return index == 0
                                                ? infoView()
                                                : sheduallist(standingsTabBloc!
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Container(
            ...
            child: Text(
              tabType == TabType.Upcoming
                  ? "You haven't joined any $txt contests"
                  : "You haven't joined any contests that are $txt",
          ...
          child: Container(
            ...
            child: Column(
              children: <Widget>[
                ...
                Container(
                  padding:
                      EdgeInsets.only(left: 0, right: 8, bottom: 8, top: 4),
                  child: Row(
                    children: <Widget>[
                      Container(
                        child: Text(
